texts = {
    "ru": {
        ...
        "access_system_update": "🎉 Хорошие новости! Мы упростили доступ к нашему боту. Теперь вам нужно только подписаться на наш канал {channel}, чтобы получить полный доступ. Кроме того, вы по-прежнему можете получать до {referral_tokens} токенов ежедневно, приглашая друзей!",
    },
    "en": {
    ...
    "uk": {
        ...
        "access_system_update": "🎉 Гарні новини! Ми спростили доступ до нашого бота. Тепер вам потрібно лише підписатися на наш канал {channel}, щоб отримати повний доступ. Крім того, ви як і раніше можете отримувати до {referral_tokens} токенів щодня, запрошуючи друзів!",
    },
}
