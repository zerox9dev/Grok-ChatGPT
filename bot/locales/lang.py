texts = {
    "ru": {
        ...
        "access_denied_subscription": "Пожалуйста, подпишитесь на чтобы получить доступ к функциям бота.",
    ...
    "en": {
        ...
        "access_denied_subscription": "Please subscribe to to get access to bot features.",
    ...
    "uk": {
        ...
        "access_denied_subscription": "Будь ласка, підпишіться на , щоб отримати доступ до функцій бота.",
