texts = {
    "ru": {
        ...
        "access_denied": "Вам нужно пригласить 1 пользователя, чтобы получить доступ к боту.",
    ...
    "en": {
        ...
        "access_denied": "You need to invite 1 user to access the bot.",
    ...
    "uk": {
        ...
        "access_denied": "Вам потрібно запросити 1 користувача, щоб отримати доступ до бота.",
