texts = {
    "ru": {
        ...
        "access_denied": "Вам нужно пригласить 3 пользователей, чтобы получить доступ к боту.",
    ...
    "en": {
        ...
        "access_denied": "You need to invite 3 users to access the bot.",
    ...
    "uk": {
        ...
        "access_denied": "Вам потрібно запросити 3 користувачів, щоб отримати доступ до бота.",
