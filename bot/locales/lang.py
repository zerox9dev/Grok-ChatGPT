texts = {
    "ru": {
        ...
        "gpt_button": "GPT-o4-mini",
        "grok_button": "Grok 3",
        "claude_button": "Claude 3 Sonnet",
        "free_llama_button": "DeepSeek V3",
        "dalle_button": "DALL-E 3",
        "grok_image_button": "Grok-2-image",
        "select_image_model": "🖼️ Выберите модель для генерации изображения:",
        "image_model_changed": "✅ Модель для генерации изображения изменена на {model}",
        ...
        "audio_description": "🎙️ Сгенерировать аудио",
        ...
        "access_denied_subscription": "Пожалуйста, подпишитесь на {channels} чтобы получить доступ к функциям бота.",
        "join_channel_button": "Подписаться на",
        ...
        "still_not_subscribed": "Вам все еще нужно подписаться на канал(ы), чтобы использовать бота:",
        "access_system_update": "🎉 Хорошие новости! Я упростил доступ к боту. Теперь вам нужно только подписаться на каналы {channels}, чтобы получить полный доступ. Кроме того, вы по-прежнему можете получать до {referral_tokens} токенов ежедневно, приглашая друзей!",
    ...
    "en": {
        ...
        "dalle_button": "DALL-E 3",
        "grok_image_button": "Grok-2-image",
        "select_image_model": "🖼️ Choose a model for image generation:",
        "image_model_changed": "✅ Image generation model changed to {model}",
        ...
        "image_description": "🖼️ Generate image",
        "audio_description": "🎙️ Generate audio",
        ...
        "access_denied_subscription": "Please subscribe to {channels} to get access to bot features.",
        "join_channel_button": "Subscribe to",
        "check_subscription_button": "I've Subscribed ✅",
        "join_channel_prompt": "Please subscribe to our channels to continue using the bot.",
        "subscription_confirmed": "Thank you for subscribing! You now have full access to the bot.",
        "still_not_subscribed": "You still need to subscribe to channel(s) to use the bot:",
        "access_system_update": "🎉 Good news! We've simplified access to our bot. Now you only need to subscribe to our channels {channels} to get full access. Plus, you can still get up to {referral_tokens} tokens daily by inviting friends!",
        "history_reset": "🔄 Message history is cleared",
    },
    "uk": {
        "start": "👋 Привіт, <b>{username}</b>\n\nЦе бот для роботи з актуальними моделями нейромереж у Telegram.\n\nКоманди:\n/start - перезапуск\n/reset - очистити історію\n/models - вибрати нейромережу\n/profile - профіль користувача\n/image - генерація зображень\n/audio - згенерувати аудіо\n/help - допомога\n\nЩоб почати використовувати нейромережу, просто напишіть текст та відправте його боту. Він використовуватиме обрану вами модель.",
        ...
        "dalle_button": "DALL-E 3",
        "grok_image_button": "Grok-2-image",
        "select_image_model": "🖼️ Оберіть модель для генерації зображення:",
        "image_model_changed": "✅ Модель для генерації зображення змінено на {model}",
        ...
        "audio_description": "🎙️ Згенерувати аудіо",
        ...
        "access_denied_subscription": "Будь ласка, підпишіться на {channels}, щоб отримати доступ до функцій бота.",
        "join_channel_button": "Підписатися на",
        "check_subscription_button": "Я підписався ✅",
        "join_channel_prompt": "Будь ласка, підпишіться на наші канали, щоб продовжити користуватися ботом.",
        "subscription_confirmed": "Дякуємо за підписку! Тепер у вас є повний доступ до бота.",
        "still_not_subscribed": "Вам все ще потрібно підписатися на канал(и), щоб користуватися ботом:",
        "access_system_update": "🎉 Гарні новини! Я спростив доступ до боту. Тепер вам потрібно лише підписатися на канали {channels}, щоб отримати повний доступ. Крім того, ви як і раніше можете отримувати {referral_tokens}+ токенів щодня, запрошуючи друзів!",
