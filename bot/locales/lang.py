texts = {
    ...
    "uk": {
        ...
        "access_denied": "👋 Привіт, <b>{username}!</b>\n\nЩоб отримати доступ до боту і зробити вашу роботу простішою та ефективнішою -Необходимо пригласить одного пользователя в бот.\n\nВаша реферальне посилання: {invite_link}",
